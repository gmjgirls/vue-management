        ...
        <div class="searchForm">
                    <el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
                        ...
                        <el-form-item label="关键字">
                            <el-input v-model="searchForm.user" placeholder="用户分类"></el-input>
                        </el-form-item>
                        <el-form-item>
...
//引入
import {accountedit,saveedit,accountdel,batchdelete,accountlistbypage} from '@/api/account/'
...
export default {
  ...
  methods: {
    ...
    handleCurrentChange(currentPage) {
        this.currentPage = currentPage;  //把用户选择当前页，赋值给data中的currentPage
        this.getAccountsByPage();
   },
    ...
    selectChange(selectData) {
      this.delIdArr = selectData.map(v => v.id); //循环选中的数据，把每一页数据的id获取到，放入一个数组中
    },
